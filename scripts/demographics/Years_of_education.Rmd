...
saveRDS(object = 
  glad_edgi_dat.exp,
  file = paste0(ilovedata, "/data/2022-09-16/glad_edgi/demographics/", "Years_of_education_GLAD_EDGI_", date, ".rds"))
saveRDS(object = 
  glad_dat.exp,
  file = paste0(ilovedata, "/data/2022-09-16/glad/demographics/", "Years_of_education_GLAD_", date, ".rds"))
saveRDS(object = 
  edgi_dat.exp,
  file = paste0(ilovedata, "/EDGI_protocol/data/demographics/", "Years_of_education_EDGI_", date, ".rds"))
