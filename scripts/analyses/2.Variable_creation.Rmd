...
dat <- dat %>%
  mutate(
    ...
    anorexia_nervosa_subtype_numeric =
      case_when(
        ed.DSM5_AN_binge_purge_binary == "DSM5 AN binge eating/purging"  ~ "Binge-eating/purging",
        
        ed.DSM5_AN_restricting_binary == "DSM5 AN restricting" ~ "Restricting",
...
# Table of frequency of eating disorder by age
```{r table freq EDs}
