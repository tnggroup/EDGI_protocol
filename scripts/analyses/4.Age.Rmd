...
png(file = "../../results/main_manuscript/EDGI_age_distribution_by_sex_for_manuscript.png",
    width = 500,
    height = 500)
...
age_sex_distribution %>%
  ...
  geom_density() +
      ...
      subtitle = paste0(
        ...
        "n = ", sum(!is.na(age_sex_distribution$age))
       # "; NA = ", sum(is.na(age_sex_distribution$age)),
      # "; n(total) = ", length(age_sex_distribution$age)
      ),
      color = "black"
    ) +
    theme(
