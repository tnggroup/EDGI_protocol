...
age_sex_distribution %>%
  ...
  geom_density() +
      ...
      subtitle = paste0(
        ...
        "n = ", sum(!is.na(age_sex_distribution$dem.dob_age)),
        "; NA = ", sum(is.na(age_sex_distribution$dem.dob_age)),
        "; n(total) = ", length(age_sex_distribution$dem.dob_age)
      ),
      color = "black"
    ) +
    theme(
