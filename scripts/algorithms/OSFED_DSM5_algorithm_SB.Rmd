...
edgi_dat_id %>% 
 filter(ed.DSM5_AN_atypical_binary_AAN_module == "DSM-5 atypical AN BMI greater than 18.55" & # Has atypical AN with weight suppression (i.e., from AAN module)
         ...
         &
             icb.3months_average_time_week == 1 # Freq and duration of purging/binge eating at SAME TIME (From typical BN criteria)
         )
        ) %>%
...
#A. Recurrent episodes of binge eating. An episode of binge eating is characterized by both of the following:
  ...
  # Did the binge eating and compensatory behaviours occur at the same time, on average, once a week for 3 months?
      (
        icb.3months_average_time_week == 0 # No - can be less frequent for people with atypical BN # Topher/Saakshi - do you agree with this?
        ) & 
