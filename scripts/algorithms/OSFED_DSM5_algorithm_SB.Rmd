...
edgi_dat_id %>% 
  select(ed.DSM5_AN_atypical_binary_AN_module, be.short_period_ate_regard, ed.BE_duration_months, icb.made_yourself_vomit, icb.making_yourself_vomit.1, icb.used_laxatives, icb.laxatives.1,icb.used_diuretics, icb.diuretics) %>% 
