...
edgi_dat_id %>% 
  select(ed.DSM5_AN_atypical_binary_AN_module, be.short_period_ate_regard, ed.BE_duration_months, icb.made_yourself_vomit, icb.making_yourself_vomit.1, icb.used_laxatives, icb.laxatives.1,icb.used_diuretics, icb.diuretics, icb.diuretics, icb.used_diet_pills, icb.weight_loss_pills.1) %>% 
  filter(ed.DSM5_AN_atypical_binary_AN_module == "DSM-5 atypical AN BMI greater than 18.55",
         (be.short_period_ate_regard == 1 &
            ed.BE_duration_months > 2.95 &  # but not equal to 0
