...
# Number of AAN with weight suppression with lifetime binge eating AND purging AND duration of BE and purging required for BN
edgi_dat_id %>% 
 filter(ed.DSM5_AN_atypical_binary_AAN_module == "DSM-5 atypical AN BMI greater than 18.55" & # Has atypical AN with weight suppression (i.e., from AAN module)
         ...
         &
             icb.binge_eating_average_month == 1 # Freq and duration of purging/binge eating at SAME TIME (From typical BN criteria)
         )
        ) %>%
  nrow() # 355 of 871 have lifetime binge eating AND purging AND these behaviours occured at the SAME TIME for 3 months
...
# Number of AAN *without* weight suppression with lifetime binge eating AND purging AND duration of BE and purging required for BN
edgi_dat_id %>% 
 filter(ed.DSM5_AN_atypical_binary_AN_module == "DSM-5 atypical AN BMI greater than 18.55" & # Has atypical AN without weight suppression (i.e., from AN module)
  ...
  nrow() # 741 of 1871 have lifetime binge eating AND purging AND these behaviours occured at the SAME TIME for 3 months
